...
Supports Preview Renders and Live Renders, Disk Renders to EXR, some of Imagine's integrated materials as uber-shaders (but no nodal shading connections),
most light types, and polymesh and subdmesh geometry (the latter with proper subdivision), and instanceSource type instancing.
